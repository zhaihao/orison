...
private[syntax] case class CFor[C <: Context with Singleton](val c: C) {
...
private[syntax] class InlineUtil[C <: Context with Singleton](val c: C) {
  import c.universe._
...
private[syntax] object CForImpl {
