...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    lazy val scalatest       = "org.scalatest"     %% "scalatest-freespec"     % "3.2.11" % Provided
    lazy val scalatest_must  = "org.scalatest"     %% "scalatest-mustmatchers" % "3.2.11" % Provided
    ...
    lazy val json4s          = "org.json4s"        %% "json4s-jackson"         % "4.0.4"  % Provided
    ...
    lazy val slick = Seq(
      ...
      "com.github.tminglei" %% "slick-pg"           % "0.20.2" % Provided,
      "com.github.tminglei" %% "slick-pg_play-json" % "0.20.2" % Provided,
      "com.github.tminglei" %% "slick-pg_jts_lt"    % "0.20.2" % Provided
    )
