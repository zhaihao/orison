...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    lazy val scalatest       = "org.scalatest"     %% "scalatest-freespec"     % "3.2.15" % Provided
    lazy val scalatest_must  = "org.scalatest"     %% "scalatest-mustmatchers" % "3.2.15" % Provided
    lazy val play_json       = "com.typesafe.play" %% "play-json"              % "2.9.4"  % Provided
    lazy val os_lib          = "com.lihaoyi"       %% "os-lib"                 % "0.9.1"  % Provided
    ...
    lazy val oshi            = "com.github.oshi"    % "oshi-core-java11"       % "6.4.0"  % Provided
