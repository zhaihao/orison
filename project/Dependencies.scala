...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    lazy val scalatest       = "org.scalatest"     %% "scalatest-freespec"     % "3.2.16" % Provided
    lazy val scalatest_must  = "org.scalatest"     %% "scalatest-mustmatchers" % "3.2.16" % Provided
    ...
    lazy val oshi            = "com.github.oshi"    % "oshi-core-java11"       % "6.4.5"  % Provided
