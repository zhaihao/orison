...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val oshi            = "com.github.oshi"    % "oshi-core-java11"       % "6.4.13" % Provided
    ...
    lazy val slick = Seq(
      ...
      "com.github.tminglei" %% "slick-pg"           % "0.22.0" % Provided,
      "com.github.tminglei" %% "slick-pg_play-json" % "0.22.0" % Provided,
      "com.github.tminglei" %% "slick-pg_jts_lt"    % "0.22.0" % Provided
    )
