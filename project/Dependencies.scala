...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    lazy val scalatest       = "org.scalatest"     %% "scalatest-freespec" % "3.2.9"  % Provided
    lazy val play_json       = "com.typesafe.play" %% "play-json"          % "2.9.2"  % Provided
    lazy val os_lib          = "com.lihaoyi"       %% "os-lib"             % "0.7.8"  % Provided
    lazy val json4s          = "org.json4s"        %% "json4s-jackson"     % "4.0.1"  % Provided
    lazy val typesafe_config = "com.typesafe"       % "config"             % "1.4.1"  % Provided
    lazy val squants         = "org.typelevel"     %% "squants"            % "1.8.1"  % Provided
